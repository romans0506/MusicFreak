...
import { getSpotifyAppToken, noteSpotify429, spotifyCooldown, spotifyUserFetch } from "@/lib/spotify"
...
export async function GET(req: NextRequest) {
  ...
  const userHeaders = { Authorization: `Bearer ${session.provider_token}` }
